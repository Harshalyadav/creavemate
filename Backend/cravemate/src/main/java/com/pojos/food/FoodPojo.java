...
@Getter
@Setter
public class FoodPojo extends BaseEntityPojo {
	...
	public FoodPojo(String name, String description, boolean veg, boolean containsEgg, double price) {
		super();
		this.name = name;
