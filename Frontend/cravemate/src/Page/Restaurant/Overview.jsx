...
//               <span className="flex items-center gap-1 text-cravemate-400">
...
const Overview = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <h1 className="text-2xl font-bold mb-4">Restaurant Overview</h1>
      <p className="text-gray-700">
        Welcome to the overview of Restaurant ID: <span className="font-semibold">{id}</span>.
      </p>
      ...
      <div className="bg-white p-6 rounded-xl shadow-md mt-6">
        ...
        <p className="text-gray-600">
          ⭐ 4.5 | 🍽️ Italian, Indian | 💰 ₹₹₹
        </p>

        <div className="mt-4">
          <h3 className="text-lg font-semibold">About</h3>
          <p className="text-gray-700">
            Experience the best Italian and Indian cuisine with a cozy ambiance and top-notch service.
          </p>
        </div>

        <div className="mt-4">
          <h3 className="text-lg font-semibold">Timings</h3>
          <p className="text-gray-700">Monday - Sunday: 10 AM - 11 PM</p>
        </div>
      </div>
    </div>
  );
